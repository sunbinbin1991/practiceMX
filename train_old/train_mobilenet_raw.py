...
def get_iterators(batch_size, data_shape=(3, 192, 192)):
...
if __name__=="__main__":
    ...
    if not os.path.exists("./log"):
        os.mkdir("./log")
    hdlr = logging.FileHandler('./log/log-mob-{}-{}.log'.format("data", 192))
    hdlr.setFormatter(formatter)
    logger.addHandler(hdlr)
    (train, val) = get_iterators(batch_size,data_shape=(3, 192, 192))
